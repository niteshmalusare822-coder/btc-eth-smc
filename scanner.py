...
# ══════════════════════════════════════════════════════════════════════════
# TUNING TOOLS (merged from tune_strategy.py)
# ══════════════════════════════════════════════════════════════════════════
# These only run when you execute this file directly:
#     python3 scanner.py            -> runs tuning (factor report + grid search)
#     python3 scanner.py live       -> runs a quick live signal + fast backtest check
#
# They do NOT run when app.py imports this file (from scanner import ...),
# so your Render web service is unaffected.
# ══════════════════════════════════════════════════════════════════════════

import copy as _copy

TUNE_SYMBOL = "BTC/USDT:USDT"   # change if needed
TUNE_ENTRY_TF = "5m"            # scalping entry timeframe to tune on
...
def step3_apply_best(results_sorted):
    ...
    print("\n" + "=" * 70)
    print("STEP 3: Best config found — paste this into CONFIG at the top of scanner.py")
    print("=" * 70)
    print(f"""
